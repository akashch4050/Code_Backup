...
char* function_GroupIDChk_in_TCE(char*,char*);
...
extern int ITK_user_main (int argc, char ** argv )
{
	...
	//printf("\n In FunToCheckTCE: login success .......");fflush(stdout);
	//printf("\n In FunToCheckTCE: Calling function_GroupIDChk_in_TCE");fflush(stdout);
	...
	//printf("\n In FunToCheckTCE: inputfile [%s]",inputfile);fflush(stdout);
	
	Response = function_GroupIDChk_in_TCE(ID,GID);
//	printf("\n In FunToCheckTCE: Ending function_GroupIDChk_in_TCE: [%s]",Response);fflush(stdout);
